...
describe('createReduxForm', function () {
  ...
  it('should provide a submit() method to submit the form', function () {
    ...
    var Container = function (_Component8) {
      _inherits(Container, _Component8);
      ...
      function Container(props) {
        ...
        _this8.submitFromParent = _this8.submitFromParent.bind(_this8);
        return _this8;
      }
  ...
  it('submitting from parent should fail if sync validation errors', function () {
    ...
    var Container = function (_Component9) {
      ...
      function Container(props) {
        ...
        _this9.submitFromParent = _this9.submitFromParent.bind(_this9);
        return _this9;
      }
  ...
  it('should only rerender the form that changed', function () {
    ...
    var FooForm = function (_Component10) {
      _inherits(FooForm, _Component10);
    ...
    var BarForm = function (_Component11) {
      _inherits(BarForm, _Component11);
  ...
  it('should only rerender the field components that change', function () {
    ...
    var FooInput = function (_Component12) {
      _inherits(FooInput, _Component12);
    ...
    var BarInput = function (_Component13) {
      _inherits(BarInput, _Component13);
    ...
    var FieldTestForm = function (_Component14) {
      _inherits(FieldTestForm, _Component14);
  ...
  it('should change nested fields', function () {
    ...
    var FormComponent = function (_Component15) {
      _inherits(FormComponent, _Component15);
