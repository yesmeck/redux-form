...
describe('readFields', function () {
  ...
  var expectField = function expectField(_ref) {
    ...
    (0, _expect2.default)(field.defaultChecked).toBe(initialValue === true);
    (0, _expect2.default)(field.defaultValue).toBe(initialValue);
  ...
  it('should mutate each node in the field tree up to the one that changed', function () {
    var props = {
      asyncBlurFields: [],
      blur: blur,
      change: change,
    ...
    var previousFields = (0, _readFields2.default)(_extends({}, props, {
      form: {
        foo: {
          bar: {
            value: 'previous'
    ...
    var nextFields = (0, _readFields2.default)(_extends({}, props, {
      form: {
        foo: {
          bar: {
            value: 'next'
    ...
    (0, _expect2.default)(nextFooBarValue).toBe('next');
    (0, _expect2.default)(nextFooBarValue).toNotBe(previousFooBarValue);
  ...
  it('should initialize new fields', function () {
    ...
    (0, _expect2.default)(result._meta.allPristine).toBe(false);
    (0, _expect2.default)(result._meta.allValid).toBe(true);
    (0, _expect2.default)(result._meta.values).toEqual({ foo: 'fooValue', bar: 'barValue', cat: undefined, dog: undefined });
    (0, _expect2.default)(result._meta.errors).toEqual({});
  });
